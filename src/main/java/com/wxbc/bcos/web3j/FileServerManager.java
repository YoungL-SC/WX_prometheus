...
public final class FileServerManager extends Contract {
    ...
    private FileServerManager(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    private FileServerManager(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public Future<TransactionReceipt> deleteById(Utf8String _serverId) {
        Function function = new Function("deleteById", Arrays.<Type>asList(_serverId), Collections.<TypeReference<?>>emptyList());
    ...
    public Future<Utf8String> find(Utf8String _serverId) {
        Function function = new Function("find", 
                Arrays.<Type>asList(_serverId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<Uint256> isServerEnable(Utf8String _serverId) {
        Function function = new Function("isServerEnable", 
                Arrays.<Type>asList(_serverId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeCallSingleValueReturnAsync(function);
    }
    ...
    public Future<TransactionReceipt> enable(Utf8String _serverId, Uint256 _enable) {
        Function function = new Function("enable", Arrays.<Type>asList(_serverId, _enable), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
    ...
    public Future<Utf8String> findIdByHostPort(Utf8String _host, Uint256 _port) {
        Function function = new Function("findIdByHostPort", 
                Arrays.<Type>asList(_host, _port), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeCallSingleValueReturnAsync(function);
    }

    public static Future<FileServerManager> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue) {
        return deployAsync(FileServerManager.class, web3j, credentials, gasPrice, gasLimit, BINARY, "", initialWeiValue);
    }

    public static Future<FileServerManager> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue) {
        return deployAsync(FileServerManager.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "", initialWeiValue);
    }

    public static FileServerManager load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new FileServerManager(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static FileServerManager load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new FileServerManager(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
